...
public class Bord {
	...
	/**
	 * Tar øverste kortet fra fra-bunken og legger dette til til-bunken (med
	...
	public void vendOversteFraBunke() {
		...
		bunkeTil.leggTil(bunkeFra.getSamling()[bunkeFra.getAntalKort() - 1]);
		bunkeFra.fjern(bunkeFra.getSamling()[bunkeFra.getAntalKort() - 1]);
